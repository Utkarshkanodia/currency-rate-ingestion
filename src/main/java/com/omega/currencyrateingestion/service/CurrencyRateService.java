...
public class CurrencyRateService {
    ...
    //    try{System.out.println(new ObjectMapper().writeValueAsString(currencyDataList));}catch(Exception e){e.printStackTrace();}
    ...
    //                 entityList.add(CurrencyRateEntity.builder().fromCurrency(currencyData.getCode()).toCurrency(set.getKey())
